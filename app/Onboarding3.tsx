...
const Onboarding3 = () => {
    ...
    return (
      ...
      <View className='mb-5 w-[80%] h-[400px] flex justify-center items-center  '>
        ...
        <Text className='text-3xl font-bold text-black'>Hire A <Text className='text-[#EA1588]'>Professional</Text></Text>
        <Text className ='w-[70%] text-[14px] text-center mb-[20px]'>Send Our Verified Professional On Errand And Deliver At The Agreement Day.</Text>
        <View  className='flex justify-center items-center w-full h-[50px]'>
          <Image source={require('../assets/images/slidecircle3.png')}>
          </Image>
        </View >
