	...
	return (
		<ScrollView>
			<View className="w-[100%] items-center h-screen">
				<Text className="w-[85%] mt-[40px] text-[30px] font-bold">
					Earnings
				</Text>
				<View className="w-[85%] h-[250px] bg-[#EA1588] mt-6 rounded-[20px] justify-center items-center">
					...
					<Text className="text-white font-bold text-[45px] mt-[10px]">
						#500,000
					</Text>
				</View>
				<View className="w-[85%] mt-[20px] flex-row justify-between">
					<Pressable
						className="w-[48%] justify-center items-center flex-row py-3 gap-x-2 rounded-[10px]"
						style={styles.border}
						onPress={() => navigate.navigate('referral')}
					>
						<View className="bg-[#EA1588] w-[35px] h-[35px] rounded-full justify-center items-center">
					...
					<Pressable className="w-[48%] bg-[#EA1588] justify-center items-center flex-row py-3 gap-x-2 rounded-[10px]">
						<View className="bg-white w-[35px] h-[35px] rounded-full justify-center items-center">
							<Image source={require('../assets/images/withdraw.png')}></Image>
						</View>
						<Text className="text-[17px] font-bold text-white">Withdraw</Text>
					</Pressable>
				</View>
				<Text className="w-[85%] mt-[50px] text-[30px] font-bold ">
					Earnings History
				</Text>
				<View
					className="w-[85%] flex-row justify-between px-3 items-center h-[70px] mt-7"
					style={styles.border}
				>
