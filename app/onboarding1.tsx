	...
	return (
		<View className="w-full h-screen bg-white flex  items-center pt-6 gap-[3px]">
			...
			<Text className="text-3xl font-bold text-black">
				Let Take <Text className="text-[#EA1588]">The Stress</Text>
			</Text>
			<Text className="w-[70%] text-[14px] text-center mb-[20px]">
				Don’t Take The Stress Of Doing It On Your Own. Our Professional Are
				Ready To Assist You.
			</Text>
			<View className="flex justify-center items-center w-full h-[50px]">
				<Image source={require('../assets/images/slideCircle.png')}></Image>
			</View>
